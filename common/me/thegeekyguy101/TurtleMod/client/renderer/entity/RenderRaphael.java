...
public class RenderRaphael extends RenderLiving {
	...
	public void renderRaphael(EntityRaphael entity, double par2, double par4, double par6, float par8, float par9) {
		super.doRenderLiving(entity, par2, par4, par6, par8, par9);
	}
	
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
		renderRaphael((EntityRaphael)par1EntityLiving, par2, par4, par6, par8, par9);
	}
	
	@Override
	public void doRender(Entity entity, double d0, double d1, double d2, float f, float f1) {
		renderRaphael((EntityRaphael)entity, d0, d1, d2, f, f1);
	}
