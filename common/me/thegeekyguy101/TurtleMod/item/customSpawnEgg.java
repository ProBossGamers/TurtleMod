...
public class customSpawnEgg extends Item {
	...
	public customSpawnEgg(int par1) {
		super(par1);
	...
	public String getItemDisplayName(ItemStack par1ItemStack) {
		...
		String s1 = customEntityList.getStringFromID(par1ItemStack
				.getItemDamage());
	...
	public int getColorFromItemStack(ItemStack par1ItemStack, int par2) {
		EntityEggInfo entityegginfo = (EntityEggInfo) customEntityList.entityEggs
				.get(Integer.valueOf(par1ItemStack.getItemDamage()));
		return entityegginfo != null ? (par2 == 0 ? entityegginfo.primaryColor
	...
	public boolean onItemUse(ItemStack par1ItemStack,
		...
		if (par3World.isRemote) {
			...
			Entity entity = spawnCreature(par3World,
				...
				if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE) {
					...
					if (par2World.getBlockMaterial(i, j, k) == Material.water) {
						Entity entity = spawnCreature(par2World,
								par1ItemStack.getItemDamage(), (double) i,
								(double) j, (double) k);
