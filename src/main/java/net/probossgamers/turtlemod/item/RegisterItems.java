...
public class RegisterItems {
    ...
    public static void itemInit() {
        ...
        GameRegistry.registerItem(mineTurtleShell, "Mine Turtle Shell");
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(mineTurtleShell), turtleShell, Blocks.stone_button, Items.redstone,  Blocks.tnt);
