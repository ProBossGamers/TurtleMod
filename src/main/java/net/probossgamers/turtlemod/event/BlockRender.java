...
import net.probossgamers.turtlemod.block.ICustomHighlightedBlock;
...
public class BlockRender
{
    ...
    @SubscribeEvent
    public void blockHighlightRenderer(DrawBlockHighlightEvent e)
    {
        if (e.target.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
        {
            ...
            if (block instanceof ICustomHighlightedBlock)
            {
                AxisAlignedBB[] bounds = ((ICustomHighlightedBlock) block).getBoxes(e.player.worldObj, x, y, z, e.player);
