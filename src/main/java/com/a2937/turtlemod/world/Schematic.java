package com.a2937.turtlemod.world;

import java.io.InputStream;

import com.a2937.turtlemod.ModInfo;
import com.a2937.turtlemod.blocks.BlockObject;
...
public class Schematic {
   ...
   public Schematic(String fileName) {
      try { 
         InputStream is = Schematic.class.getResourceAsStream("/assets/" + ModInfo.MODID + "/schematics/" + fileName + ".schematic"); 
