package com.probossgamers.turtlemod.packets;
 ...
 * could be done anywhere, however, even in your TurtleMain class, but I will be adding other
 ...
 */
 ...
 //PacketDispatcher.registerMessage(MessageExtendedReachAttack.Handler.class, MessageExtendedReachAttack.class, Side.SERVER);	 
 //PacketDispatcher.registerMessage(BuddyPacket.Handler.class, BuddyPacket.class, Side.SERVER);
 //PacketDispatcher.registerMessage(SyncPlayerPropsMessage.Handler.class, SyncPlayerPropsMessage.class, Side.CLIENT);
 //PacketDispatcher.registerMessage(SpawnProjectilePacket.Handler.class, SpawnProjectilePacket.class, Side.SERVER);
